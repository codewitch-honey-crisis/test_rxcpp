...
Example_capture_t Example_runner32(int32_t* dfa, int32_t* blockEnd, unsigned long long* position, Example_callback callback, void* callback_state) {
...
Example_capture_t Example_runner16(int16_t* dfa, int16_t* blockEnd, unsigned long long* position, Example_callback callback, void* callback_state) {
	Example_capture_t result;
	result.position = 0;
	result.length = 0;
	unsigned long long adv = 0;
...
Example_capture_t Example_runner8(int8_t* dfa, int8_t* blockEnd, unsigned long long* position, Example_callback callback, void* callback_state) {
	Example_capture_t result;
	result.position = 0;
	result.length = 0;
	unsigned long long adv = 0;
...
Example_capture_t match_Identifier(unsigned long long* position,Example_callback callback, void* callback_state) {
	return Example_runner32(Identifier_dfa, NULL, position, callback, callback_state);
}
